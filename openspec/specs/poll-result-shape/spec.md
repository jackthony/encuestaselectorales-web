...
`data/encuesta.json`/`data/resultado.json` data shapes and their validation (structural, cross-reference, percentage-sum) — the poll/result foundation `BL-13`/`BL-14` render (`BL-12`).

        ...
        return DB::transaction(function () use ($data): InteractiveVote {
            ...
            try {
                return InteractiveVote::query()->create([
                    ...
                    'device_token_ciphertext' => $signals->deviceTokenCiphertext,
                    'device_token_nonce' => $signals->deviceTokenNonce,
                    'device_token_auth_tag' => $signals->deviceTokenAuthTag,
                    'device_token_hmac' => $signals->deviceHmac,
                    'device_hmac_key_version' => $signals->deviceHmacKeyVersion,
                    'browser_fingerprint_ciphertext' => $signals->browserFingerprintCiphertext,
                    'browser_fingerprint_nonce' => $signals->browserFingerprintNonce,
                    'browser_fingerprint_auth_tag' => $signals->browserFingerprintAuthTag,

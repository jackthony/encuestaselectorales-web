...
## Purpose
The site's authority rests on every published number being real. This capability guarantees no fabricated poll, pollster, or result data ever ships to a production page — fabricated content must be absent, not merely labeled.

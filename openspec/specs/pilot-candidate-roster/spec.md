...
The Miraflores 2022 mayoral race — 8 real, ONPE/JNE-reported candidates and their 8 parties — used as the documented historical set that unblocks `BL-10`/`BL-11` before real 2026 JNE candidate data exists (`BL-09`).

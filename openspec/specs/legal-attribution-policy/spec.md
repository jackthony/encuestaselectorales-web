...
Rules for citing third-party content (pollster PDFs, JNE photos, judicial records) and
the correction/right-of-reply process — the site's highest-consequence legal-exposure
area for a solo operator (`BL-05`).
